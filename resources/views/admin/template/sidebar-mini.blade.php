...
<ul class="sidebar-menu">
	...
	<li class="treeview @if(request()->segment(2) == 'user') active @endif">
	  ...
	  <ul class="treeview-menu">
	    <li><a href="{{route('admin.user.index')}}"><i class="fa fa-circle-o text-success"></i> Lijst admins</a></li>
	    <li><a href="/admin/clients"><i class="fa fa-circle-o text-success"></i> Lijst klanten</a></li>
	...
	<li class="treeview @if(request()->segment(2) == 'page') active @endif">
		...
		<ul class="treeview-menu">
			...
			<li><a href="{{route('admin.showAllPriceLists.create')}}"><i class="fa fa-plus text-danger"></i> Prijslijst toevoegen</a></li>
