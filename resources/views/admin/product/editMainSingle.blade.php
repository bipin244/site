...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Alleenstaand product bijwerken</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            ...
            <form id="formCreateProduct" action="/admin/product/updateMainSingle" role="form" class="form" method="post">
                <input type="hidden" name="productId" value="{{$product->id}}">
                <div class="form-group">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="productNrOld" value="{{$product->productNr}}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div id="productNrRow" class="row">
                                            <div class="col-md-4">
                                                <input id="productNrinput" name="productNrSingle" type="text" class="form-control" value="{{$product->productNr}}" placeholder="ProductNr" />
                                                <div class="spacersmallest"></div>
                                                <input id="EANNumberSingle" name="EANNumberSingle" type="text" class="form-control" value="{{$product->EANNumber}}" placeholder="EAN-nummer" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div id="productNrRow" class="row">
                                <input type="hidden" id="catsToRemove" name="catsToRemove" value="">
                                @foreach($product->categories as $category)
                                <div class="col-md-2">
                                    <p>{{$category->naam_nl}}</p>
                                    <a class="removeCat" data-cat-id="{{$category->category_id}}"><i class="glyphicon glyphicon-remove-sign" style="margin-top:6px;"></i></a>
                                </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <script>
                    ...
                    $(document).on('click','.removeCat',function(){
                        console.log("clickCatRemove");
                        if($('#catsToRemove').val().length > 0){
                            catsToRemove.push($(this).data("catId"));
                        }else{
                            catsToRemove.push($(this).data("catId"));
                        }

                        $('#catsToRemove').val(catsToRemove);
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <input id="title_nl" name="title_nl" type="text" class="form-control" placeholder="Naam (Nederlands)" value="{{$product->naam_nl}}" />
                        </div>
                        <div class="col-md-3">
                            <input id="title_fr" name="title_fr" type="text" class="form-control" placeholder="Naam (Frans)" value="{{$product->naam_fr}}" />
                        </div>
                        <div class="col-md-3">
                            <input id="title_de" name="title_de" type="text" class="form-control" placeholder="Naam (Duits)" value="{{$product->naam_de}}" />
                        </div>
                        <div class="col-md-3">
                            <input id="title_en" name="title_en" type="text" class="form-control" placeholder="Naam (Engels)" value="{{$product->naam_en}}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <textarea name="description_short_nl" id="description_short_nl" rows="3" class="form-control" placeholder="Korte beschrijving product (Nederlands)">{{$product->beschrijving_kort_nl}}</textarea>
                        </div>
                        <div class="col-md-3">
                            <textarea name="description_short_fr" id="description_short_fr" rows="3" class="form-control" placeholder="Korte beschrijving product (Frans)">{{$product->beschrijving_kort_fr}}</textarea>
                        </div>
                        <div class="col-md-3">
                            <textarea name="description_short_de" id="description_short_de" rows="3" class="form-control" placeholder="Korte beschrijving product (Duits)">{{$product->beschrijving_kort_de}}</textarea>
                        </div>
                        <div class="col-md-3">
                            <textarea name="description_short_en" id="description_short_en" rows="3" class="form-control" placeholder="Korte beschrijving product (Engels)">{{$product->beschrijving_kort_en}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row spacersmall"></div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <textarea name="description_long_nl" id="description_long_nl" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Nederlands)">{{$product->beschrijving_lang_nl}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <textarea name="description_long_fr" id="description_long_fr" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Frans)">{{$product->beschrijving_lang_fr}}</textarea>
                        </div>
                    </div>
                    <div class="row spacersmallest"></div>
                    <div class="row">
                        <div class="col-md-6">
                            <textarea name="description_long_de" id="description_long_de" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Duits)">{{$product->beschrijving_lang_de}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <textarea name="description_long_en" id="description_long_en" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Engels)">{{$product->beschrijving_lang_en}}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div id="itemslider-zoom" class="thumbnails show-all auto-adjust-width">
                                @foreach($product->images as $image)
                                    <div id="{{$image->id}}" class="item imageItem">
                                        ...
                                        <a href="#" data-image-id="{{$image->id}}" class="btn btn-danger removeImage">Verwijderen</a>
                                    </div>
                                    <?php $tellerDataSlide++;?>
                                @endforeach
                            </div>
                ...
                <script>
                    ...
                    $(document).on('click','.removeImage',function(event){
                        if($(".removeImage").length == 1){
                            event.preventDefault();
                            Command: toastr["error"]("Voeg eerst een andere afbeelding toe. Je moet minstens één afbeelding hebben")
                            toastr.options = {
                                "closeButton": false,
                                "debug": false,
                                "newestOnTop": false,
                            ...
                            if($('#imageToRemove').val().length > 0){
                                imageToRemove.push(imageId);
                            }else{
                                imageToRemove.push(imageId);
                            }

                            $('#imageToRemove').val(imageToRemove);
                ...
                <div class="form-group" style="min-height: 200px;">
                    <input id="relatedToRemove" name="relatedToRemove" type="hidden" value="">
                    <?php $teller = 1;?>
                @foreach($related as $relatedproduct)
                    ...
                    <div class="col-md-2">
                        <a href="#">
                            <div id="{{$relatedproduct->product_related_id}}" class="product-image-wrapper">
                                ...
                                <div class="choose text-center">
                                    <a href="#" data-related-id="{{$relatedproduct->product_related_id}}" class="btn btn-danger removeRelated"><i class="fa icon-remove-sign"></i> Verwijderen</a>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <script>
                    var relatedToRemove = new Array();
                    $(document).on('click','.removeRelated',function(event){
                        event.preventDefault();
                        var relatedId = $(this).data("relatedId");

                        if($('#relatedToRemove').val().length > 0){
                            relatedToRemove.push(relatedId);
                        }else{
                            relatedToRemove.push(relatedId);
                        }

                        $('#relatedToRemove').val(relatedToRemove);
