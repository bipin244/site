...
@section('content')
			...
			<div class="row">
				...
				<div class="col-md-2 no-padding-right">
					<select name="colors[]" id="colors" class="form-control colorselectors colorsSelector">
						<option class="colorItem" value="">Kies kleur</option>
						@foreach($colors as $color)
				...
				<div class="col-md-2 no-padding-right">
					<select name="coatings[]" id="colors" class="form-control coatingSelector">
						<option class="coatingItem" value="">Kies coating</option>
	...
	<div class="box">
		<div class="box-header with-border">
		  <h3 class="box-title">Product Toevoegen</h3>
		</div><!-- /.box-header -->
		<div class="box-body">
				...
				<div class="col-md-2">
					...
					<select class="form-control hoofdcategorie">
						@foreach($categories as $key => $category)
							<option value="{{$category->id}}" data-param-key="{{$key}}" class="headcatoption">{{$category->naam_nl}}</option>
						@endforeach
					</select>
				</div>
				<div class="col-md-2">
					<label>Subcategory</label>
					<select name="categoryselection[]" id="categoryselection" class="form-control categoryselection">
		    ...
		    <form id="formCreateProduct" action="{{route('admin.product.store')}}" role="form" class="form" method="post">
				<div class="form-group">
					...
					<!-- text input -->
					<label for="category">ProductNr (Niet in te vullen indien meerdere kleuren of afmetingen beschikbaar)</label>
					<div class="row">
						<div class="col-md-7">
							<div id="productNrRow" class="row">
								<div class="col-md-4">
									<input id="productNrinput" name="productNrSingle" type="text" class="form-control" placeholder="ProductNr" />
									<div class="spacersmallest"></div>
									<input id="EANNumberSingle" name="EANNumberSingle" type="text" class="form-control" placeholder="EAN-nummer" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					<div class="row categorySelectionContainer">
						...
						<div class="col-md-2">
							...
							<select name="categoryselection[]" id="categoryselection" class="form-control categoryselection">
								@foreach($categories[0]->subcategories as $category)
									<option value="{{$category->id}}">{{$category->naam_nl}}</option>
								@endforeach
							</select>
						</div>
					...
					<div class="row">
						<div class="col-md-3">
							<a class="addCategory btn btn-sml btn-primary">Nog een categorie toewijzen</a>
						</div>
					</div>
				</div>
		        ...
		        <div class="form-group">
		          <label for="title">Naam<span class="text text-danger">*</span></label>
					<div class="row">
						<div class="col-md-3">
							<input id="title_nl" name="title_nl" type="text" class="form-control" placeholder="Naam (Nederlands)" value="{{old('title')}}" />
						</div>
						<div class="col-md-3">
							<input id="title_fr" name="title_fr" type="text" class="form-control" placeholder="Naam (Frans)" value="{{old('title')}}" />
						</div>
						<div class="col-md-3">
					  		<input id="title_de" name="title_de" type="text" class="form-control" placeholder="Naam (Duits)" value="{{old('title')}}" />
						</div>
						<div class="col-md-3">
					  		<input id="title_en" name="title_en" type="text" class="form-control" placeholder="Naam (Engels)" value="{{old('title')}}" />
						</div>
					</div>
		        </div>
		        ...
		        <div class="form-group">
					...
					<div class="row">
						<div class="col-md-3">
							<textarea name="description_short_nl" id="description_short_nl" rows="3" class="form-control" placeholder="Korte beschrijving product (Nederlands)">{{old('content')}}</textarea>
						</div>
						<div class="col-md-3">
							<textarea name="description_short_fr" id="description_short_fr" rows="3" class="form-control" placeholder="Korte beschrijving product (Frans)">{{old('content')}}</textarea>
						</div>
						<div class="col-md-3">
							<textarea name="description_short_de" id="description_short_de" rows="3" class="form-control" placeholder="Korte beschrijving product (Duits)">{{old('content')}}</textarea>
						</div>
						<div class="col-md-3">
							<textarea name="description_short_en" id="description_short_en" rows="3" class="form-control" placeholder="Korte beschrijving product (Engels)">{{old('content')}}</textarea>
						</div>
					</div>
				</div>
				<div class="row spacersmall"></div>
				<div class="form-group">
					<label for="content">Gedetailleerde Beschrijving</label>
					<div class="row">
						<div class="col-md-6">
							<textarea name="description_long_nl" id="description_long_nl" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Nederlands)">{{old('content')}}</textarea>
						</div>
						<div class="col-md-6">
							<textarea name="description_long_fr" id="description_long_fr" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Frans)">{{old('content')}}</textarea>
						</div>
					</div>
					<div class="row spacersmallest"></div>
					<div class="row">
						<div class="col-md-6">
							<textarea name="description_long_de" id="description_long_de" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Duits)">{{old('content')}}</textarea>
						</div>
						<div class="col-md-6">
							<textarea name="description_long_en" id="description_long_en" rows="5" class="form-control" placeholder="Gedetailleerde beschrijving product (Engels)">{{old('content')}}</textarea>
						</div>
					</div>
				</div>
				...
				<div id="productNr" class="form-group">
					<div class="row">
					<div class="col-md-3">
						<input id="levertermijnSingle" name="levertermijnSingle" type="text" class="form-control" placeholder="Levertermijn" />
					</div>

					<div class="col-md-3"><input type="checkbox" value="1" name="voorraadcheckbox" class="voorraadcheckboxclass" checked />In voorraad</div>
                        <div class="col-md-4">
                            <textarea name="searchIndexes[]" id="searchIndexe" rows="3" class="form-control" placeholder="Zoektermen opgeven (zoekterm1, zoekterm2, ...)"></textarea>
                        </div>
						<div id="addcolors" class="col-md-5">
								<h4>Kleur toevoegen</h4>
								<div class="row">
									<div class="col-md-3">
										<a id="openAddColor" class="btn btn-sml btn-success" data-toggle="modal" data-target="#myModal">Kleur Toevoegen</a>
									</div>
								</div>
						</div>
						<div id="addcolors" class="col-md-5">
							<h4>Coating toevoegen</h4>
							<div class="row">
								<div class="col-md-3">
									<a id="openAddCoating" class="btn btn-sml btn-success" data-toggle="modal" data-target="#myModalCoating">Coating Toevoegen</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					<label for="category">Meerdere productNr's</label>
					<div class="row">
						<div id="sizesdiv" class="col-md-12">
							<div class="row">
								<div class="col-md-2">
									<a id="addcolorsize" class="btn btn-sml btn-primary">Sub product toevoegen</a>
								</div>
								<div class="col-md-2">
									<a id="removeallinsides" class="btn btn-sml btn-danger" style="display:none;">Alles verwijderen</a>
								</div>
							</div>
						</div>
				...
				jQuery('#formCreateProduct').bind('submit',function(e){
					console.log("kleir");
					if($("#mainimgvalues").val() == "" || $("#mainimgvalues").val().length <= 0){
						Command: toastr["error"]("Kies minstens één afbeelding voor het main product.", "Kies een afbeelding")
						toastr.options = {
							"closeButton": false,
							"debug": false,
							"newestOnTop": false,
					...
					if(productNrsTrue){
						console.log(productNrsTrue);
						if(allProductNrsSet == false){
							console.log(allProductNrsSet);
							Command: toastr["error"]("U heeft één of meerdere productNr's van de subProducten niet ingevuld.", "Kijk alle productNr velden na!")
							toastr.options = {
								"closeButton": false,
								"debug": false,
								"newestOnTop": false,
					...
					} else if($("#productNrinput").val().length === 0){
							console.log("insideProductNrinput = empty");
							e.preventDefault();
							Command: toastr["error"]("ProductNr ontbreekt.", "Vul de productNr bovenaan in!")
							toastr.options = {
								"closeButton": false,
								"debug": false,
								"newestOnTop": false,
			...
			<div id="myModalCoating" class="modal fade" role="dialog">
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<input type="text" class="form-control coatingInputNL coatingInputField" value="" placeholder="Naam (Nederlands)">
								</div>
							</div>
							<div class="row spacersmallest"></div>
							<div class="row">
								<div class="col-md-12">
									<input type="text" class="form-control coatingInputFR coatingInputField" value="" placeholder="Naam (Frans)">
								</div>
							</div>
							<div class="row spacersmallest"></div>
							<div class="row">
								<div class="col-md-12">
									<input type="text" class="form-control coatingInputDE coatingInputField" value="" placeholder="Naam (Duits)">
								</div>
							</div>
							<div class="row spacersmallest"></div>
							<div class="row">
								<div class="col-md-12">
									<input type="text" class="form-control coatingInputEN coatingInputField" value="" placeholder="Naam (Engels)">
								</div>
							</div>
						</div>
						<div class="modal-footer">
							<div class="row">
								...
								<div class="col-md-3 col-md-push-6">
									<a id="saveCoating" class="btn btn-sml btn-success" data-dismiss="modal">Coating toevoegen</a>
								</div>
							</div>
						</div>
					</div>
			...
			<script>
				$('#saveCoating').click(function(){
					...
					$.ajax({
						...
						cache: false,
						success: function(data){
							var newcoating = jQuery.parseJSON(data);
							$(".coatingSelector").each(function(){
								$(this).append('<option class="coatingItem" value="' + newcoating.id + '">' + newcoating.naamnl +  '</option>');
							});

							$(".coatingInputField").each(function(){
								$(this).val("");
							});
						}
					});
