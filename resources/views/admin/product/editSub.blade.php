...
@section('content')
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Subproduct bijwerken</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            <form id="formCreateProduct" action="/admin/product/updateSub" role="form" class="form" method="post">
                ...
                <div id="colorandsizerow" class="row spacersmallest insideparamdiv">
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-3 productNrCol"><input id="productNrs" name="productNr" type="text" value="{{$product->productNr}}" class="form-control productNrsValue" placeholder="productNr" /></div>
                            <div class="col-md-2 no-padding-right">
                                <select name="color" id="color" class="form-control colorselectors colorsSelector">
                                    <option class="colorItem" value="NULL">Kies kleur</option>
                                    @foreach($colors as $color)
                                        <?php if($color->id == $product->colorId){?>
                                        <option class="colorItem" value="{{$color->id}}" selected>{{$color->naam_nl}}</option>
                                        <?php }else{?>
                                        <option class="colorItem" value="{{$color->id}}">{{$color->naam_nl}}</option>
                                        <?php }?>
                                    @endforeach
                            ...
                            <div class="col-md-2 no-padding-right">
                                <select name="coating" id="colors" class="form-control coatingSelector">
                                    <option class="coatingItem" value="NULL">Kies coating</option>
                                    @foreach($coatings as $coating)
                                        <?php if($coating->id == $product->coatingId){?>
                                            <option class="coatingItem" value="{{$coating->id}}" selected>{{$coating->coatingnaam_nl}}</option>
                                        <?php }else{?>
                                            <option class="coatingItem" value="{{$coating->id}}">{{$coating->coatingnaam_nl}}</option>
                                        <?php }?>
                                    @endforeach
                            ...
                            <div class="col-md-3"><input id="productSizes" name="productSize" type="text" value="{{$product->afmeting}}" class="form-control" placeholder="afmeting en/of diameter" /></div>
                            <div class="col-md-2"><input id="productDiktes" name="productDikte" type="text" value="{{$product->dikte}}" class="form-control" placeholder="dikte" /></div>
                        </div>
                        <div class="row spacersmall"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input id="EANNumberSingle" name="EANNumber" value="{{$product->EANNumber}}" type="text" class="form-control" placeholder="EAN-nummer" />
                                <div class="spacersmallest"></div>
                                <textarea name="searchIndexes" id="searchIndexes"  value="{{$product->searchKeywords}}" rows="3" class="form-control" placeholder="Zoektermen opgeven (zoekterm1, zoekterm2, ...)"></textarea>
                                <div class="spacersmallest"></div>
                                <input id="verpakkingsaantal" name="verpakkingsaantal" type="text" class="form-control" placeholder="Verpakkingseenheid" />
                                <div class="spacersmallest"></div>
                                <select name="verpakkingsEenheden" id="verpakkingsEenheden" class="form-control selectVeenheid">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-4">
                                <textarea name="description_short_nl" id="description_short_nl" rows="3" class="form-control" placeholder="Gedetailleerde informatie (Nederlands)">{{$product->beschrijving_nl}}</textarea>
                                <textarea name="description_short_fr" id="description_short_nl" rows="3" class="form-control"  placeholder="Gedetailleerde informatie (Frans)">{{$product->beschrijving_fr}}</textarea>
                                <textarea name="description_short_de" id="description_short_nl" rows="3" class="form-control" placeholder="Gedetailleerde informatie (Duits)">{{$product->beschrijving_de}}</textarea>
                                <textarea name="description_short_en" id="description_short_nl" rows="3" class="form-control"  placeholder="Gedetailleerde informatie (Engels)">{{$product->beschrijving_en}}</textarea>
                            </div>
                            <?php if($product->voorraad == 1){?>
                                <input type="checkbox" value="1" name="voorraadcheckbox" class="voorraadcheckboxclass" style="display:none;" checked/>
                                <input id="voorraadvalue" type="hidden" value="1" name="voorraad"/>
                            <?php }else{?>
                                <input type="checkbox" value="0" name="voorraadcheckbox" class="voorraadcheckboxclass" style="display:none;"/>
                                <input id="voorraadvalue" type="hidden" value="0" name="voorraad"/>
                            <?php }?>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="min-height: 200px;">
                    ...
                    @foreach($product->relatedProducts as $relatedproduct)
                        ...
                        if($teller % 2 != 0 && $teller == sizeof($product->relatedProducts)){
                            echo '</div>';
                        }?>
                        <?php $teller++;?>
                    @endforeach
