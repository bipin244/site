			...
			<div class="box-body row">
				<div class="col-md-8">
			        ...
			        <div class="form-group">
			          ...
			          <input id="title" name="title" type="text" class="form-control" placeholder="Post title" value="{{$post->key?$post->key:old('key')}}" />
			        </div>
			        <div class="form-group">
			          <label for="content">Content</label>
			          <textarea name="content" id="content" rows="7" class="form-control" placeholder="Post content">{{$post->key?$post->key:old('content')}}</textarea>
			        </div>
			        <div class="form-group">
